...
immutable D1{X1} <: Traits.Trait{Tuple{}}
    ...
    function D1()
        new(Traits.FDict(
             sin => _sin(::X1, ::Float64) = nothing,
             cos => _cos(::X1, ::Float64) = nothing
             ),
            Bool[],
            []
            )
...
immutable D2{X1,X2} <: Traits.Trait{Tuple{D1{X1}, D1{X2}}}
    ...
    function D2()
        new(Traits.FDict(
             (+) => _plus(::X1, ::X2, ::Any) = nothing,
             (-) => _minus(::X1, ::X2, ::Any) = nothing
             ),
            Bool[],
            []
            )
...
immutable D3{X1} <: Traits.Trait{Tuple{}}
    ...
    function D3()
        new(Traits.FDict(
             getkey => _getkey(::X1,::Any, ::Any, ::Any) = nothing,
             get!   => _get!(::X1, ::Any, ::Any, ::Any) = nothing
             ),
            Bool[],
            []
            )
...
immutable Tr01{X} <: Traits.Trait{Tuple{}}
    ...
    function Tr01()
        new(Traits.FDict(
                         g01 => _g01{T<:X}(::T, ::T, ::Type{T}) = nothing
                         ),
            Bool[],
            []
            )
...
immutable Tr02{X} <: Traits.Trait{Tuple{}}
    ...
    function Tr02()
        new(Traits.FDict(
                         g02 => _g02{T<:X}(::T, ::T, ::Type{T}) = nothing
                         ),
            Bool[],
            []
            )
...
immutable Tr03{X} <: Traits.Trait{Tuple{}}
    ...
    function Tr03()
        new(Traits.FDict(
                         g03 => _g03{T<:X}(::T, ::Vector{T}, ::T) = nothing
                         ),
            Bool[],
            []
            )
...
#         A1 = getassoc(X)
#         new(Traits.FDict(
#                          g04 => _g04{T<:X}(::T, ::Vector{T}, ::A1, ::T) = nothing 
#                          ),
#             Bool[],
#             [A1]
#             )
