...
# @traitfn f2{X,Y<:AbstractFloat; D1{X}, D1{Y}  }(x::X,y::Y) = cos(x) - cos(y)
...
f2{X,Y<:AbstractFloat}(x::X, y::Y) = f2(x, y, f2(TraitType(), x,y) )
...
@inline f2{X,Y<:AbstractFloat}(x::X, y::Y, ::Type{ Tuple{D1{X}, D1{Y}} }) = cos(x) - cos(y)

# the trait dispatch.  Here I rename all the arguments and type parameters.

function f2{X1,X2<:AbstractFloat}(::TraitType, ::Type{X1}, ::Type{X2})
...
@generated function f2{X1,X2<:AbstractFloat}(::TraitType, x1::X1, x2::X2)
...
f1{X,Y<:AbstractFloat}(x::X, y::Y) = _trait_f1(x, y, _trait_type_f1(x,y) )
...
@inline _trait_f1{X,Y<:AbstractFloat}(x::X, y::Y, ::Type{ Tuple{D1{X}, D1{Y}} }) = cos(x) - cos(y)

# the trait dispatch.  Here I rename all the arguments and type parameters.

function _trait_type_f1{X1,X2<:AbstractFloat}(::Type{X1}, ::Type{X2})
    # This method serves as a storage for the trait-types of a certain
    # normal-type signature.
    [Tuple{D1{X1}, D1{X2}}], Any[:(Tuple{D1{X1}, D1{X2}})]
end
@generated function _trait_type_f1{X1,X2<:AbstractFloat}(x1::X1, x2::X2)
